...
| Kotlin 実行 parity 全体 | `bash popcoon-tdd/kotlin_parity/run_all.sh` | 全 14 ハーネス pass (`run.sh` は 164 matched / 0 mismatched、`run_compile_core.sh` は 46 ファイル実コンパイル) |
