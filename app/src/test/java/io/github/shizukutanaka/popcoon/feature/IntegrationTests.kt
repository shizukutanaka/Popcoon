package io.github.shizukutanaka.popcoon.feature
...
class IntegrationTests : StringSpec({
    ...
    "サクラ疑い商品: 大量レビュー満点 → LOW 判定" {
        val rt = io.github.shizukutanaka.popcoon.feature.review.ReviewTrustScorer
            .evaluate(rating = 4.95f, reviewCount = 5000)
        rt.trust shouldBe io.github.shizukutanaka.popcoon.feature.review.ReviewTrustScorer.Trust.LOW
    }

    "ダークパターン: 偽緊急性 + Drip Pricing を同時検出" {
        val dp = io.github.shizukutanaka.popcoon.feature.darkpattern.DarkPatternDetector
        ...
        types shouldContain io.github.shizukutanaka.popcoon.feature.darkpattern.DarkPatternDetector.WarningType.FAKE_SCARCITY
        types shouldContain io.github.shizukutanaka.popcoon.feature.darkpattern.DarkPatternDetector.WarningType.COUNTDOWN_MANIPULATION
        drip.shouldNotBeNull()
    }

    "名寄せ: 同一型番は3モールで1グループ、最安が代表" {
        val pm = io.github.shizukutanaka.popcoon.feature.matching.ProductMatcher
        fun p(sku: String, plat: io.github.shizukutanaka.popcoon.data.model.Platform, price: Long) =
        ...
        val groups = pm.groupByIdentity(
            listOf(
                p("A", io.github.shizukutanaka.popcoon.data.model.Platform.AMAZON, 40000),
                p("R", io.github.shizukutanaka.popcoon.data.model.Platform.RAKUTEN, 37000),
                p("Y", io.github.shizukutanaka.popcoon.data.model.Platform.YAHOO, 39000),
            ),
        )
    ...
    "買い時総合: ATL付近 + 自然レビュー + 警告なし = 高信頼の買い推奨" {
        ...
        rt.trust shouldBe io.github.shizukutanaka.popcoon.feature.review.ReviewTrustScorer.Trust.HIGH
    }
